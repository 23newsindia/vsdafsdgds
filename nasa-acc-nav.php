...
$is_dashboard = !$is_orders_page && !is_wc_endpoint_url('edit-account') && !is_wc_endpoint_url('edit-address') && !is_wc_endpoint_url('downloads');
...
<div class="order-desktop">
    <div class="my-account">
        <div class="myaccount-order">
            <?php if ($is_dashboard): ?>
                <!-- Dashboard - Show mobile layout directly without sidebar -->
                <div class="myaccountmainmobile snipcss-J9kFJ">
                        ...
                        <div class="profile">
                            <div class="edit-profile">
                                <a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-account', '', wc_get_page_permalink( 'myaccount' ) ) ); ?>">
                                    <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%23666'%3E%3Cpath d='M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z'/%3E%3C/svg%3E" alt="Edit Profile" id="style-NgjaD" class="style-NgjaD">
                                </a>
                            </div>
                            <div class="snipcss0-0-0-1">
                                <p id="style-s67Un" class="style-s67Un"><?php echo esc_html($first_letter); ?></p>
                            </div>
                    ...
                    <!-- Navigation Menu - Always visible on dashboard -->
                                        ...
                                        <a href="<?php echo esc_url( wc_get_account_endpoint_url( $endpoint ) ); ?>" <?php echo ($endpoint === 'customer-logout') ? 'data-logout="true"' : ''; ?>>
                                            <div class="tabmain">
                                                <div class="svgtext">
                                                    ...
                                                    switch($endpoint) {
                                                        case 'dashboard':
                                                            $icon_svg = '<img src="data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\' fill=\'%23666\'%3E%3Cpath d=\'M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z\'/%3E%3C/svg%3E" width="25" height="25" id="style-A8vXQ" class="style-A8vXQ">';
                                                            break;
                                                        case 'orders':
                                                            $icon_svg = '<img src="data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\' fill=\'%23666\'%3E%3Cpath d=\'M7 4V2C7 1.45 7.45 1 8 1H16C16.55 1 17 1.45 17 2V4H20C20.55 4 21 4.45 21 5S20.55 6 20 6H19V19C19 20.1 18.1 21 17 21H7C5.9 21 5 20.1 5 19V6H4C3.45 6 3 5.55 3 5S3.45 4 4 4H7ZM9 3V4H15V3H9ZM7 6V19H17V6H7Z\'/%3E%3C/svg%3E" width="25" height="25" id="style-A8vXQ" class="style-A8vXQ">';
                                                            break;
                                                        case 'downloads':
                                                            $icon_svg = '<img src="data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\' fill=\'%23666\'%3E%3Cpath d=\'M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z\'/%3E%3C/svg%3E" width="25" height="25" id="style-HprGb" class="style-HprGb">';
                                                            break;
                                                        case 'edit-address':
                                                            $icon_svg = '<img src="data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\' fill=\'%23666\'%3E%3Cpath d=\'M12 2C8.13 2 5 5.13 5 9C5 14.25 12 22 12 22S19 14.25 19 9C19 5.13 15.87 2 12 2ZM12 11.5C10.62 11.5 9.5 10.38 9.5 9S10.62 6.5 12 6.5S14.5 7.62 14.5 9S13.38 11.5 12 11.5Z\'/%3E%3C/svg%3E" width="25" height="25" id="style-Tl7lA" class="style-Tl7lA">';
                                                            break;
                                                        case 'edit-account':
                                                            $icon_svg = '<img src="data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\' fill=\'%23666\'%3E%3Cpath d=\'M12 12C14.21 12 16 10.21 16 8S14.21 4 12 4S8 5.79 8 8S9.79 12 12 12ZM12 14C9.33 14 4 15.34 4 18V20H20V18C20 15.34 14.67 14 12 14Z\'/%3E%3C/svg%3E" width="25" height="25" id="style-UXzjm" class="style-UXzjm">';
                                                            break;
                                                        case 'customer-logout':
                                                            $icon_svg = '<img src="data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\' fill=\'%23666\'%3E%3Cpath d=\'M17 7L15.59 8.41L18.17 11H8V13H18.17L15.59 15.59L17 17L22 12L17 7ZM4 5H12V3H4C2.9 3 2 3.9 2 5V19C2 20.1 2.9 21 4 21H12V19H4V5Z\'/%3E%3C/svg%3E" width="25" height="25" id="style-v1oDM" class="style-v1oDM">';
                                                            break;
                                                        default:
                                                ...
                                                <div class="icondown">
                                                    <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%23666'%3E%3Cpath d='M8.59 16.59L13.17 12L8.59 7.41L10 6L16 12L10 18L8.59 16.59Z'/%3E%3C/svg%3E" width="20" height="20" id="style-RvecR" class="style-RvecR">
                                                </div>
                                            </div>
                                        </a>
                                    </li>
            ...
            <?php else: ?>
                <!-- Other pages - Show with sidebar layout -->
                <!-- Left Sidebar -->
                                        ...
                                        <a href="<?php echo esc_url( wc_get_account_endpoint_url( $endpoint ) ); ?>" <?php echo ($endpoint === 'customer-logout') ? 'data-logout="true"' : ''; ?>>
                                            <div class="tabmain">
                                                <div class="svgtext">
                                                    ...
                                                    switch($endpoint) {
                                                        case 'dashboard':
                                                            $icon_svg = '<img src="data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\' fill=\'%23666\'%3E%3Cpath d=\'M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z\'/%3E%3C/svg%3E" width="25" height="25">';
                                                            break;
                                                        case 'orders':
                                                            $icon_svg = '<img src="data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\' fill=\'%23666\'%3E%3Cpath d=\'M7 4V2C7 1.45 7.45 1 8 1H16C16.55 1 17 1.45 17 2V4H20C20.55 4 21 4.45 21 5S20.55 6 20 6H19V19C19 20.1 18.1 21 17 21H7C5.9 21 5 20.1 5 19V6H4C3.45 6 3 5.55 3 5S3.45 4 4 4H7ZM9 3V4H15V3H9ZM7 6V19H17V6H7Z\'/%3E%3C/svg%3E" width="25" height="25">';
                                                            break;
                                                        case 'downloads':
                                                            $icon_svg = '<img src="data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\' fill=\'%23666\'%3E%3Cpath d=\'M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z\'/%3E%3C/svg%3E" width="25" height="25">';
                                                            break;
                                                        case 'edit-address':
