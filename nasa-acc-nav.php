...
$is_dashboard = is_wc_endpoint_url('dashboard') || (!is_wc_endpoint_url());
$is_downloads = is_wc_endpoint_url('downloads');
$is_addresses = is_wc_endpoint_url('edit-address');
$is_account_details = is_wc_endpoint_url('edit-account');
    ...
    <div class="my-account">
        <div class="myaccount-order">
            ...
            <div class="leftside-my-account">
                <!-- Mobile Menu Toggle - Only show on non-dashboard pages -->
                <?php if (!$is_dashboard): ?>
                ...
                <div class="userprofileleft">
                    <div class="profile">
                        ...
                        <div class="avatar-upload-section">
                            <div class="snipcss0-0-0-1 default-avatar">
                                    ...
                                    <a href="<?php echo esc_url( wc_get_account_endpoint_url( $endpoint ) ); ?>" <?php echo ($endpoint === 'customer-logout') ? 'data-logout="true"' : ''; ?>>
                                        <div class="tabmain">
                                            <div class="svgtext">
                                                ...
                                                switch($endpoint) {
                                                    case 'dashboard':
                                                        $icon_svg = '<img src="data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\' fill=\'%23666\'%3E%3Cpath d=\'M4 6H2V20C2 21.1 2.9 22 4 22H18V20H4V6ZM20 2H8C6.9 2 6 2.9 6 4V16C6 17.1 6.9 18 8 18H20C21.1 18 22 17.1 22 16V4C22 2.9 21.1 2 20 2ZM20 16H8V4H20V16ZM10 9H18V11H10V9ZM10 12H16V14H10V12ZM10 6H18V8H10V6Z\'/%3E%3C/svg%3E" width="25" height="25">';
                                                        break;
                                                    case 'orders':
                                                        ...
                                                        break;
                                                    case 'downloads':
                                                        $icon_svg = '<img src="data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\' fill=\'%23666\'%3E%3Cpath d=\'M5 20H19V18H5M19 9H15V3H9V9H5L12 16L19 9Z\'/%3E%3C/svg%3E" width="25" height="25">';
                                                        break;
                                                    case 'edit-address':
            ...
            <div class="rightside-my-account">
                ...
                <?php elseif ($is_downloads || $is_addresses || $is_account_details): ?>
                    <!-- WooCommerce Content Pages -->
                    <div class="woocommerce-content-wrapper">
                        <div class="usermyaccaddress">
                            <div class="top-heading-main">
                                ...
                                <p class="heading-top">
                                    <?php 
                                    if ($is_downloads) echo 'Downloads';
                                    elseif ($is_addresses) echo 'Addresses';
                                    elseif ($is_account_details) echo 'Account Details';
                                    ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="woocommerce-account-content">
                            <?php
                            // This will display the actual WooCommerce content
